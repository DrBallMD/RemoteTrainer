...
{
    partial class AddStudyDataForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Входные параметры указанные через точку с запятой";
            // 
            // label2
            // 
            ...
            this.label2.Text = "Выходные параметры, указанные через точку с запятой";
            // 
            // button1
            // 
            ...
            this.Name = "AddStudyDataForm";
            this.Text = "AddStudyDataForm";
